...
<head>
    ...
    <script>
        var pluginVersion = localStorage.getItem('version') ?? '1.0.0'
        function getHttpObj() {
            var httpobj = null;
            if (IEVersion() < 10) {
                try {
        ...
        function LoadPublishAddons() {
            var addonList = document.getElementById("addonList");
		var curList = [{"name":"wpsdemo","addonType":"wps","online":"false","enable": "true","url":"http://127.0.0.1/wps/wpsdemo.7z","version": pluginVersion}];
            curList.forEach(function (element) {
...
<body onload="LoadAddons()">
    <div class="divone">
        <div class="divTitle" id="divTitle">WPS插件安装</div>
        ...
        <div class="ClearAll" onclick="ClearAll()" id="ClearAll" hidden>禁用所有 WPS 加载项</div>
    </div>
</body>
